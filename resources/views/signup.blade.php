                        ...
                        <div class="contact-form widget-shadow widget-contact">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6 mb-4">
                                    <label for="validationDefault01" class="form-label linehight_19 font_16 grey ps-3">First Name*</label>
                                    <input type="text" class="form-control linehight_19 font_16 ps-3" id="validationDefault01" name="fname" placeholder="First Name" required>
                                </div>
                                <!-- (Last_Name) -->
                                <div class="col-12 col-md-6 mb-4">
                                    <label for="exampleInputLastName" class="form-label linehight_19 font_16 grey ps-3">Last Name*</label>
                                    <input type="text" class="form-control linehight_19 font_16 ps-3" id="exampleInputLastName" name="lname" placeholder="Last Name" required>
                                </div>
                                <!-- (Business_Name) -->
                                <div class="col-12 mb-4">
                                    <label for="exampleInputBusiness" class="form-label linehight_19 font_16 grey ps-3">Business Name*</label>
                                    <input required type="text" class="form-control linehight_19 font_16 ps-3" id="exampleInputBusiness" name="cmpname" placeholder="Business Name">
                                </div>
                                <!-- (Address) -->
                                <div class="col-12 mb-4">
                                    <label for="exampleInputaddress" class="form-label linehight_19 font_16 grey ps-3">Address*</label>
                                    <input required type="text" class="form-control linehight_19 font_16 ps-3 controls" id="pac-input" name="address" placeholder="Street Address" autocomplete="off">
                                </div>
                                <!-- (City) -->
                                <div class="col-12 col-md-6 mb-4">
                                    <label for="exampleInputCity" class="form-label linehight_19 font_16 grey ps-3">City*</label>
                                    <input required type="text" class="form-control linehight_19 font_16 ps-3" id="exampleInputCity" aria-describedby="NameHelp" name="city" placeholder="City">
                                </div>
                                <!-- (State/Province) -->
                                <div class="col-12 col-md-6 mb-4">
                                    <label for="exampleInputState" class="form-label linehight_19 font_16 grey ps-3">State/Province*</label>
                                    <input required type="text" class="form-control linehight_19 font_16 ps-3" id="exampleInputState" aria-describedby="NameHelp" name="state" placeholder="State/Province">
                                </div>
                                <!-- (Country) -->
                                <div class="col-12 mb-4">
                                    <div class="form-group">
                                        ...
                                        <span class="form-input">
                                            <select class="form-control linehight_19 font_16 ps-3" id="" name="country" required>
                                                <option selected disabled value="">United States</option>
                                                <option>Dalas</option>
                                                <option>USA</option>
                                                <option>123</option>
                                            </select>
                                ...
                                <div class="col-12 col-md-6 mb-4">
                                    ...
                                    <input required type="text" class="form-control linehight_19 font_16 ps-3" id="exampleInputPhone" aria-describedby="PhoneHelp" name="mobphone" placeholder="Mobile Phone">
                                </div>
                                <!-- (Client_Count) -->
                                <div class="col-12 col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <span class="form-input">
                                            <select class="form-control linehight_19 font_16 ps-3 clients" id="" name="clientcount" required>
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <input required type="email" class="form-control linehight_19 font_16 ps-3 " name="email" id="exampleInputEmail" placeholder="This Will Be Your Username">
                                </div>
                                <!-- (Password) -->
                                <div class="col-12 mb-4">
                                    <label for="exampleInputPassword" class="form-label linehight_19 font_16 grey ps-3">Password*</label>
                                    <input required type="password" class="form-control linehight_19 font_16 ps-3  password-taker" id="exampleInputPassword" name="password" placeholder="Password">
                                </div>
                                <!-- (Form-Footer) -->
                        ...
                        <div class="contact-form widget-shadow widget-contact">
                            ...
                            <div class="tab-content mt-5" id="pills-tabContent">
                                    ...
                                    <div class="planing-tabs mb-5">
                                        ...
                                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="public tab-pane fade show active price-calculation-area" id="startup" role="tabpanel" aria-labelledby="startup-tab">
                                                <div class="data d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="data d-flex align-items-center justify-content-between lighten-gray">
                                                    <div class="d-flex justify-content-start">
                                                        <small class="inehight_19 font_16 grey fw-500 ps-5">Clients/Properties</small>
                                                    </div>
                                                    <di class="d-flex justify-content-end align-items-center">
                                                        <div class="data--table">
                                                ...
                                                <div class="data d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="data d-flex align-items-center justify-content-end">
                                                        <div class="data--table">
                                                            <div class="round">
                                            ...
                                            <div class="public tab-pane price-calculation-area fade" id="standard" role="tabpanel" aria-labelledby="standard-tab">
                                                <div class="data d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="d-flex justify-content-end align-items-center">
                                                        <div class="data--table">
                                                            <small class="item2 text-center widget-subtitle grey d-block monthly-current">$49.50</small>
                                                        </div>
                                                        <div class="data--table">
                                                            <small class="text-center widget-subtitle grey d-block monthly-standarad-current">$99.00</small>
                                                        </div>
                                                ...
                                                <div class="data d-flex align-items-center justify-content-between lighten-gray">
                                                    ...
                                                    <di class="d-flex justify-content-end align-items-center">
                                                        <div class="data--table">
                                                            <small class="item2 linehight_19 font_16 grey text-center d-block fw-500">11 - 40</small>
                                                        </div>
                                                        <div class="data--table">
                                                            <small class="linehight_19 font_16 grey text-center d-block fw-500">41 - 301</small>
                                                        </div>
                                                ...
                                                <div class="data d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end">
                                                        ...
                                                        <div class="data--table">
                                                            <div class="round">
                                                                <input required type="checkbox" id="checkbox12" />
                                                                <label class="item2" for="checkbox12"></label>
                                                            </div>
                                                        </div>
                                                        <div class="data--table">
                                                            <div class="round">
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="list-group">
                                                    <a href="#" class="list-group-item list-group-item-action active header d-flex justify-content-between text-white rounded triangle text-decoration-none" aria-current="true">
                                                    ...
                                                    {{-- <div class="col-sm-12 col-md-6 ">
                                                    <div class="list-group">
                                                        <a href="#" class="list-group-item list-group-item-action header d-flex justify-content-between text-white rounded triangle text-decoration-none" aria-current="true">
                                        ...
                                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="enterprise-anually" role="tabpanel" aria-labelledby="enterprise-anually-tab">
                                                ...
                                                <div class="w-75 primary_color_bg ms-auto d-flex align-items-center justify-content-between px-5 py-4 mt-3 rounded">
                                                    ...
                                                    <div class="form-group w-25">
                                                        <span class="form-input">
                                                            <select class="form-control linehight_19 font_16 ps-3" id="">
                                                ...
                                                <div class="row mt-5">
                                                    ...
                                                    <div class="col-sm-12 col-md-6 ">
                                                        <div class="list-group">
                                                            <a href="#" class="text-decoration-none list-group-item list-group-item-action header d-flex justify-content-between text-white rounded triangle" aria-current="true">
                                                                <p class="widget-subtitle p-0 m-0 ">One-Time Setup & Training</p>
                                                                <p class="widget-subtitle p-0 m-0 ">$50</p>
                                                            </a>
                                                            <div class="text lighten-gray">
                                ...
                                <div class="d-flex align-items-center pt-5">
                                    <a href="#" class="back-to-basic text-decoration-none"><img src="images/pre-btn.svg" class="img-fluid" alt=""></a>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="payment-method p-payment-method">
                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <span class="form-input">
                                                        <input required type="text" class="form-control linehight_19 font_16 px-4" id="exampleInputCardNumber" name="cardnum" required data-keeper-lock-id="" placeholder="Card Number">
                                                ...
                                                <div class="col-12 mb-3">
                                                    <label for="" class="form-label linehight_19 font_16 grey px-4">VAT Number (optional)</label>
                                                    <input required type="text" class="form-control px-4" id="" name="vat" placeholder="VAT Number" required>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="primary-padding mt-5 d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="#" class="back-to-palns text-decoration-none"><img src="images/pre-btn.svg" class="img-fluid" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    <div class="order-summary p-payment-method primary_color_bg">
                                        ...
                                        <hr>
                                        <h6 class="widget-subtitle text-white pb-3 m-0 ps-3">Coupon Code</h6>
                                        <form class="coupon-code d-flex align-items-center justify-content-between coupon_check">
                                            {{ csrf_field() }}
                                            <input required type="text" class="form-control coupon-field ps-3" id="code" name="coupon" placeholder="coupon code" required>
                                        ...
                                        <p class="font_14 text-white py-5">All subscription plans will be automatically renewed using the payment method you provide today.
                                            You may cancel at anytime to avoid future charges. By clicking “Pay & Create Account”, you agree to Pool Service Software
                                            <span class="bold">Terms of Use</span> and
                                            <span class="bold">Privacy Statement</span>.
                                        </p>
                                        <span class="form-input d-flex justify-content-center position-relative">
                                            <a href="#" class="text-decoration-none pay-btn ps-4 secondary_color_bg text-white  linehight_19 font_16 grey bold d-flex align-items-center justify-content-center flex-direction-columns">Pay
                                                & Create Account
