    ...
    <section class="widget-contact position-relative">
        <div class="container text-center">
            ...
            <div class="d-flex align-items-center pb-4 pt-2 justify-content-center">
                <h3 class="primary_color_text tag-title m-0">Subscription</h3>
                <h3 class="secondary_color_text tag-title m-0 ps-2">Started</h3>
            </div>
        </div>
        <div class="form-width text-center">
            <form class="contact-form widget-shadow form-md-padding">
                ...
                <a href="https://live.poolservice.software/admin" type="button" class="btn text-white font_20 linehight_23 b-100-radious md-btn secondary_color_bg">Confirm</a>
                </div>
            </form>
        </div>
    </section>
